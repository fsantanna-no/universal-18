...
Em particular, o modo de espera é responsável por 10 a 15\% do consumo
residencial.
...
periféricos que devem permanecer ligados, e aplicar os modos de energia mais
...
%
\CEU é baseada no modelo de concorrência síncrono, em que todas as reações ao
...
%
A linguagem já possui suporte básico recente ao tratamento de interrupções e
...
%
As soluções completas de hardware para IoT atuais são até acessíveis mas pouco
flexíveis, pois tipicamente possuem componentes SMD reduzidos já soldados às
placas.
Em particular, os módulos de rádio são previamente determinados, criando uma
barreira para a experimentação.
Mesmo que muitas dessas soluções sejam abertas, o custo de seus componentes é
alto para compras em pequenas quantidades e o método de montagem industrial não
é adequado para pesquisa e educação.
%
